...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.name as dep_name from mngrisk m1
				 ...
				 where  d1.main_dep='$main_dep' and t1.move_status='N' and t1.take_date between '$take_date1' and '$take_date2' group by d1.dep_id order by number_risk DESC");	
...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.name as dep_name from mngrisk m1
				 ...
				 LEFT OUTER JOIN department d1 on t1.res_dep = d1.dep_id
                                 LEFT OUTER JOIN department_group d2 on d2.main_dep = d1.main_dep
				 where  d1.main_dep='$main_dep' and m1.mng_status='$mng_status' and t1.take_date between '$date_start' and '$date_end' and t1.move_status='N'   group by d1.dep_id order by number_risk DESC");	
...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.name as dep_name from mngrisk m1
				 ...
				 LEFT OUTER JOIN department d1 on t1.res_dep = d1.dep_id
                                 LEFT OUTER JOIN department_group d2 on d2.main_dep = d1.main_dep
				 where  d1.main_dep='$main_dep' and m1.mng_status='$mng_status' and m1.mng_status='N' and t1.recycle='N' and t1.take_date between '$take_date1' and '$take_date2' group by d1.dep_id order by number_risk DESC");	
	...
	echo "<p>&nbsp;</p></center>";
				 ...
				 LEFT OUTER JOIN department d1 on t1.res_dep = d1.dep_id
                                 LEFT OUTER JOIN department_group d2 on d2.main_dep = d1.main_dep
				 where  d1.main_dep='$main_dep' and t1.move_status='N' and t1.take_date between '$date_start' and '$date_end' group by d1.dep_id order by number_risk DESC");
 }					 
...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.dep_id,d1.name as dep_name from mngrisk m1
				 ...
				 LEFT OUTER JOIN department d1 on t1.res_dep = d1.dep_id
                                 LEFT OUTER JOIN department_group d2 on d2.main_dep = d1.main_dep
				 where  d1.main_dep='$main_dep' and m1.mng_status='$mng_status' and t1.take_date between '$date_start' and '$date_end' and t1.move_status='N' and t1.recycle='N'  group by d1.dep_id order by number_risk DESC");	
				$i=1;
				while($rs=mysql_fetch_assoc($sql)){
					$dep_id=$rs[dep_id];	
					echo "<tr>"; 
...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.dep_id,d1.name as dep_name from mngrisk m1
				 ...
				 LEFT OUTER JOIN department d1 on t1.res_dep = d1.dep_id
                                 LEFT OUTER JOIN department_group d2 on d2.main_dep = d1.main_dep
				 where  d1.main_dep='$main_dep' and m1.mng_status='$mng_status' and t1.move_status='N' and t1.recycle='N' and t1.take_date between '$take_date1' and '$take_date2' group by d1.dep_id order by number_risk DESC");	
				$i=1;
				while($rs=mysql_fetch_assoc($sql)){
					$dep_id=$rs[dep_id];		
					echo "<tr>"; 
