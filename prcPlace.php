...
<?PHP
 echo "<br><br><br><br>";
	...
	if($_POST[method]=='update'){
		$place=$_POST[place];	 
		$sqlUpdate=mysql_query("update place SET name='$name' 
		where place='$place' "); 	
 							...
 							if($sqlUpdate==false){
											 ...
											 echo "<a href='frmPlace.php' >กลับ</a>";
									...
									echo " <div class='bs-example'>
										...
										echo "<div class='alert alert-info alert-dismissable'>
							 		 	 ...
							 		 	 echo" <META HTTP-EQUIV='Refresh' CONTENT='2;URL=frmPlace.php'>";
								}
   
   }//-----------------------------------------end update
   else if($method=='delete'){	 	 
   $place=$_GET[place];	 	  
		$sqlDelete=mysql_query("delete from place  
		where place='$place' "); 
 	 	...
 	 	$sqlInsert=mysql_query("insert into place  SET    name='$name' "); 
