...
if($take_date1!='' and $mng_status==''){  
	...
	echo "หน่วยงาน 11: $res[name]&nbsp;&nbsp;&nbsp;&nbsp;";
 	echo "ตั้งแต่วันที่ ".DateThai1($take_date1);
	echo "&nbsp;&nbsp;&nbsp;&nbsp;";
	echo "ถึงวันที่ ".DateThai2($take_date2);
	echo "<p>&nbsp;</p></center>";
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.name as dep_name ,c1.name as category_name,c1.category ,t1.level_risk ,t1.subcategory ,t1.res_dep 
				 from mngrisk m1
				 ...
				 where  t1.res_dep='$take_dep' and t1.category='$category' and  t1.move_status='N' and t1.take_date between '$take_date1' and '$take_date2' group by t1.level_risk order by r1.level_risk  ASC");	
...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.name as dep_name ,c1.name as category_name,c1.category ,t1.level_risk,t1.subcategory ,t1.res_dep 
				 ...
				 LEFT OUTER JOIN category c1 on c1.category = t1.category
				 LEFT OUTER JOIN level_risk r1 on r1.level_risk = t1.level_risk
 				 where  t1.res_dep='$take_dep' and t1.category='$category' and m1.mng_status='$mng_status' and t1.move_status='N'
                                 and t1.take_date between '$take_date1' and '$take_date2' group by t1.level_risk  order by r1.level_risk ASC");	

}else if($take_date1!='' and $mng_status!=''){  

	echo "<B>หมวด</B> : $resCate[name]<br /><br /><center>";
	echo "หน่วยงาน 33: $res[name]&nbsp;&nbsp;&nbsp;&nbsp;";
...
,t1.res_dep   
				 ...
				 LEFT OUTER JOIN category c1 on c1.category = t1.category
				 LEFT OUTER JOIN level_risk r1 on r1.level_risk = t1.level_risk
 				 where  t1.res_dep='$take_dep' and t1.category='$category' and m1.mng_status='$mng_status' and t1.move_status='N' and t1.take_date between '$take_date1' and '$take_date2' group by t1.level_risk  order by r1.level_risk ASC ");	
...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.name as dep_name ,c1.name as category_name,c1.category ,t1.level_risk,t1.subcategory ,t1.res_dep 
				 ...
				 LEFT OUTER JOIN category c1 on c1.category = t1.category
				 LEFT OUTER JOIN level_risk r1 on r1.level_risk = t1.level_risk
 				 where  t1.res_dep='$take_dep' and t1.category='$category' and m1.mng_status='$mng_status' and t1.move_status='N'   group by t1.level_risk  order by r1.level_risk ASC");	
...
,t1.res_dep   
	...
	echo "<p>&nbsp;</p></center>";
				 ...
				 LEFT OUTER JOIN category c1 on c1.category = t1.category
				 LEFT OUTER JOIN level_risk r1 on r1.level_risk = t1.level_risk
				 where  t1.res_dep='$take_dep' and t1.category='$category' and t1.move_status='N' group by t1.level_risk order by r1.level_risk ASC");
 }	
...
<tr bgcolor=<?=$bg?> onmouseover="mOvr(this,'#DEF8F0');" onclick=mClk(this); onmouseout=mOut(this); >
	<TD><CENTER>
 	...
 	<a href='main_report4_2.php?level_risk=<?=$rs[level_risk]?>&take_dep=<?=$rs[res_dep]?>&category=<?=$rs[category]?>&mng_status=<?=$mng_status?>&take_date1=<?=$take_date1?>&take_date2=<?=$take_date2?>&type=1' title='ดูรายงานแยกตามเรื่อง'><?php echo $i; ?></CENTER></a></TD>
	<TD><a href='main_report4_2.php?level_risk=<?=$rs[level_risk]?>&take_dep=<?=$rs[res_dep]?>&category=<?=$rs[category]?>&mng_status=<?=$mng_status?>&take_date1=<?=$take_date1?>&take_date2=<?=$take_date2?>&type=1' title='ดูรายงานแยกตามเรื่อง'><?php echo $rs[level_risk];?></a></TD>
	<TD><a href='main_report4_2.php?level_risk=<?=$rs[level_risk]?>&take_dep=<?=$rs[res_dep]?>&category=<?=$rs[category]?>&mng_status=<?=$mng_status?>&take_date1=<?=$take_date1?>&take_date2=<?=$take_date2?>&type=1' title='ดูรายงานแยกตามเรื่อง'><p align="right"><?php echo $rs[number_risk];?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></TD>
</TR>
