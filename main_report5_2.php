...
function page_navigator($before_p,$plus_p,$total,$total_p,$chk_page){   
	global $e_page;
	global $querystr;
	$urlfile="main_report5_2.php"; // ส่วนของไฟล์เรียกใช้งาน ด้วย ajax (ajax_dat.php)
	$per_page=10;
...
if($take_date1!='' and $mng_status==''){  
	...
	$q="select t1.move_status,t1.take_rec_date,t1.takerisk_id,t1.take_date,d1.name as dep_name,c1.name as cate_name,s1.name as subct_name,t1.level_risk,m1.mng_status,t1.takerisk_id,t1.take_detail
		...
		LEFT OUTER JOIN level_risk r1 on r1.level_risk = t1.level_risk
				 where  t1.subcategory='$subcategory' and t1.level_risk='$level_risk' and t1.res_dep='$take_dep' and t1.category='$category' and  t1.move_status='N' and t1.take_date between '$take_date1' and '$take_date2'  order by t1.takerisk_id desc";	

}else if($take_date1=='' and $mng_status!=''){ 
	echo "<B>หมวด</B> : $resCate[name]&nbsp;&nbsp;&nbsp;&nbsp; <BR><BR><b>เรื่อง :</b> $resSubCate[name]&nbsp;&nbsp;&nbsp;&nbsp;<BR><BR><b>ระดับความรุนแรง :</br> $level_risk<br /><br />";
	echo "<b>หน่วยงาน :</b> $res[name]&nbsp;&nbsp;&nbsp;&nbsp;<BR><BR>";
	...
	$q="select t1.move_status,t1.take_rec_date,t1.takerisk_id,t1.take_date,d1.name as dep_name,c1.name as cate_name,s1.name as subct_name,t1.level_risk,m1.mng_status,t1.takerisk_id, t1.take_detail
		...
		LEFT OUTER JOIN subcategory s1 on s1.subcategory = t1.subcategory
		LEFT OUTER JOIN level_risk r1 on r1.level_risk = t1.level_risk
 				 where  t1.subcategory='$subcategory' and t1.level_risk='$level_risk' and t1.res_dep='$take_dep' and t1.category='$category' and m1.mng_status='$mng_status' and t1.move_status='N'     order by t1.takerisk_id desc";	
	...
	$q="select t1.move_status,t1.take_rec_date,t1.takerisk_id,t1.take_date,d1.name as dep_name,c1.name as cate_name,s1.name as subct_name,t1.level_risk,m1.mng_status,t1.takerisk_id,t1.take_detail
		...
		LEFT OUTER JOIN subcategory s1 on s1.subcategory = t1.subcategory
		LEFT OUTER JOIN level_risk r1 on r1.level_risk = t1.level_risk			 
				 where t1.subcategory='$subcategory' and t1.level_risk='$level_risk' and t1.res_dep='$take_dep' and t1.category='$category' and m1.mng_status='$mng_status' and t1.move_status='N' and t1.take_date between '$take_date1' and '$take_date2'    order by t1.takerisk_id desc ";	
	...
	$q="select t1.move_status,t1.take_rec_date,t1.takerisk_id,t1.take_date,d1.name as dep_name,c1.name as cate_name,s1.name as subct_name,t1.level_risk,m1.mng_status,t1.takerisk_id,t1.take_detail
		...
		LEFT OUTER JOIN subcategory s1 on s1.subcategory = t1.subcategory
		LEFT OUTER JOIN level_risk r1 on r1.level_risk = t1.level_risk
				 where t1.subcategory='$subcategory' and t1.level_risk='$level_risk' and t1.res_dep='$take_dep' and t1.category='$category' and t1.move_status='N'   order by t1.takerisk_id desc";
...
<TR>
					...
					<th width='71%'><CENTER><p>รายการ <i class="fa fa-sort"></i></p></CENTER></th>
					<th width='10%'><CENTER><p>ได้รับเมื่อ <i class="fa fa-sort"></i></p></CENTER></th>
					<th width='12%'><CENTER><p>Status  <i class="fa fa-sort"></i></p></CENTER></th>
</TR>
<?php  
