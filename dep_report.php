...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.name as dep_name from mngrisk m1
				 LEFT OUTER JOIN takerisk t1 on t1.takerisk_id = m1.takerisk_id
				 LEFT OUTER JOIN department d1 on t1.take_dep = d1.dep_id
 				 where   m1.mng_status='$mng_status' and t1.move_status='N' and t1.take_date between '$date_start' and '$date_end'   group by d1.dep_id order by number_risk DESC");	
...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.dep_id,d1.name as dep_name from mngrisk m1
				...
				while($rs=mysql_fetch_assoc($sql)){
					...
					echo "<TD><a href='session_search.php?report=report_department1&dep_id=$rs[dep_id]&move_status=N&take_date1=$take_date&take_date2=$take_date2'>$rs[dep_name] </a></TD>";
...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.dep_id,d1.name as dep_name from mngrisk m1
				...
				while($rs=mysql_fetch_assoc($sql)){
					...
					echo "<tr>"; 
					echo "<TD><CENTER>$i</CENTER></TD>";
					echo "<TD><a href='session_search.php?report=report_department2&mng_status=$mng_status&dep_id=$rs[dep_id]&move_status=N'>$rs[dep_name] </a></TD>";
					echo "<TD><p align='right'> $rs[number_risk] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></TD>";
					echo "</TR>"; 
				$i++;
				}
...
$sql=mysql_query("select count(mngrisk_id) as number_risk,d1.dep_id,d1.name as dep_name from mngrisk m1
				...
				while($rs=mysql_fetch_assoc($sql)){
					...
					echo "<tr>"; 
					echo "<TD><CENTER>$i</CENTER></TD>";
					echo "<TD><a href='session_search.php?report=report_department3&mng_status=$mng_status&dep_id=$dep_id&move_status=N&take_date1=$take_date&take_date2=$take_date2'>$rs[dep_name] </a></TD>";
					echo "<TD><p align='right'> $rs[number_risk] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></TD>";
					echo "</TR>"; 
				$i++;
				}
				...
				while($rs=mysql_fetch_assoc($sql)){
					...
					echo "<tr>"; 
					echo "<TD><CENTER>$i</CENTER></TD>";
					echo "<TD><a href='session_search.php?report=report_department4&dep_id=$dep_id&move_status=N'>$rs[dep_name] </a></TD>";
					echo "<TD><p align='right'> $rs[number_risk] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></TD>";
					echo "</TR>"; 
				$i++;
				}
